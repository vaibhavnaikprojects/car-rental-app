...
public class RentalQueries {
	...
	public static final String OWNER_REPORT = "select * from rental where ownerId=?";
	public static final String CAR_TYPE_REPORT = "select * from rental where vehicleId in (select vehicleId from carType where carTypeId=?)";
	public static final String OWNER_CAR_REPORT = "select * from rental where ownerId=? and vehicleId=?";
