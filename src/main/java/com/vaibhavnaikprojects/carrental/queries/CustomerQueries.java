...
public class CustomerQueries {
	...
	public static final String INACTIVATE_CUSTOMER = "delete from CUSTOMER where id=?";
	public static final String GET_CUSTOMERS = "select * from customer c,customertype ct where c.customerTypeId=ct.customerTypeId";
	public static final String GET_CUSTOMERS_BY_AVAILABLITY = "select * from customer c,customertype ct where c.customerTypeId=ct.customerTypeId and status=?";
